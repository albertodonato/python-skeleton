...
.. |Build Status| image:: https://github.com/albertodonato/python-skeleton/actions/workflows/ci.yaml/badge.svg?branch=main
   :alt: Build Status
   :target: https://github.com/albertodonato/python-skeleton/actions?query=workflow%3ACI+branch%3Amain
